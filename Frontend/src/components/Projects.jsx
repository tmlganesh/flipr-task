                    ...
                    {projects.length > 0 ? projects.map((project) => (
                        ...
                        <>
                            <div className="group relative overflow-hidden rounded-lg shadow-lg">
                                <img src="/assets/project-1.svg" alt="Project 1" className="w-full h-64 object-cover transform group-hover:scale-110 transition duration-500" />
                                <div className="absolute inset-0 bg-black bg-opacity-50 opacity-0 group-hover:opacity-100 transition duration-500 flex flex-col justify-end p-6">
                            ...
                            <div className="group relative overflow-hidden rounded-lg shadow-lg">
                                <img src="/assets/project-2.svg" alt="Project 2" className="w-full h-64 object-cover transform group-hover:scale-110 transition duration-500" />
                                <div className="absolute inset-0 bg-black bg-opacity-50 opacity-0 group-hover:opacity-100 transition duration-500 flex flex-col justify-end p-6">
                            ...
                            <div className="group relative overflow-hidden rounded-lg shadow-lg">
                                <img src="/assets/project-3.svg" alt="Project 3" className="w-full h-64 object-cover transform group-hover:scale-110 transition duration-500" />
                                <div className="absolute inset-0 bg-black bg-opacity-50 opacity-0 group-hover:opacity-100 transition duration-500 flex flex-col justify-end p-6">
